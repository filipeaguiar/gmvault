...
params:
  kind: "monster"
stats_meta: "Large monstrosity, leal e mau"
stats:
  ac: "14"
  hp: "68 (8d10 + 24)"
...
![Arte: manticore](/images/campaigns/journeys-through-the-radiant-citadel/manticore.webp)
...
**Bite.** mw 5 to hit, reach 5 ft., one target. {@h}7 ([[1d8+3]]) piercing damage.

**Claw.** mw 5 to hit, reach 5 ft., one target. {@h}6 ([[1d6+3]]) slashing damage.

**Tail Spike.** rw 5 to hit, range 100/200 ft., one target. {@h}7 ([[1d8+3]]) piercing damage.
