...
params:
  kind: "monster"
stats_meta: "Medium fiend, neutro e mau"
stats:
  ac: "13"
  hp: "78 (12d8 + 24)"
...
![Arte: tlacatecolo](/images/campaigns/journeys-through-the-radiant-citadel/tlacatecolo.webp)
...
**Talon.** mw 6 to hit, reach 5 ft., one target. {@h}8 ([[1d8+3]]) piercing damage plus 14 ([[3d8]]) poison damage.
...
**Plague Winds (Fiend Form Only; Recharge 5-6).** The tlacatecolo emits a chilling, disease-ridden wind in a 60-foot line that is 10 feet wide. Each creature in that area must succeed on a CD 13 Constitution saving throw or take 26 ([[4d12]]) cold damage and become poisoned.

While poisoned in this way, the creature can't regain hit points. At the end of every hour, the creature must succeed on a CD 13 Constitution saving throw or gain 1 level of exhaustion. If the creature is in direct sunlight when it makes this saving throw, it automatically succeeds on the save.
