...
O espião causa 7 (<span class="dice+" data-roll-notation="2d6">2d6</span>) de dano extra ao atingir um alvo com um ataque com arma e tiver vantagem na jogada de ataque, ou quando o alvo estiver a até 1,5 metro de um aliado do espião que não esteja incapacitado e o espião não tiver desvantagem na jogada de ataque.
...
Corpo a Corpo 4 para atingir, alcance 1,5 m, um alvo. {@h}5 (<span class="dice+" data-roll-notation="1d6+2">1d6 + 2</span>) de dano perfurante.


### Besta de Mão

À Distância 4 para atingir, alcance 9/36 m, um alvo. {@h}5 (<span class="dice+" data-roll-notation="1d6+2">1d6 + 2</span>) de dano perfurante.
