---
title: "Cena 2 - Running the Adventure"
kind: "scene"
draft: true
titulo_pt_br: ""
visibility: "gm"
...
* **Easy (CD 10**). An easy task requires a minimal level of competence or a modicum of luck to accomplish.
* **Moderate (CD 15**). A moderate task requires a slightly higher level of competence to accomplish. A character with a combination of natural aptitude and specialized training can accomplish a moderate task more often than not.
* **Hard (CD 20**). Hard tasks include any effort that is beyond the capabilities of most people without aid or exceptional ability.
