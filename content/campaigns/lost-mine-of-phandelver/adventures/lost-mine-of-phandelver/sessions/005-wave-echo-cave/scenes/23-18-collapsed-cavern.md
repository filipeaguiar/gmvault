...
The rift is 20 feet deep. Climbing up or down without using a rope requires a successful CD 10 Strength (Athletics) check. A creature that fails the check by 5 or more falls and takes [[1d6]] bludgeoning damage per 10 feet fallen, landing Prone at the bottom.
