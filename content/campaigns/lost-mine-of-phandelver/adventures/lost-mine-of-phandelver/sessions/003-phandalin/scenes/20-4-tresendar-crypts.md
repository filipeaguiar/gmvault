---
title: "Cena 20 - 4. Tresendar Crypts"
params:
  kind: "scene"
draft: true
titulo_pt_br: ""
...
The three skeletons are animated and attack any creature that comes within 10 feet of the door leading to **Área 5** or the door leading to **Área 6**, unless that creature is wearing the scarlet cloak of the Redbrands or speaks the password "Illefarn" (the name of an ancient elven nation, which once spread across much of the Sword Coast).
...
Fighting in this room alerts the Redbrands in **Área 5** that trouble is on the way.
