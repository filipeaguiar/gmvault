# Inline Class Feature Descriptions Specification

## Purpose
Render canonical class and subclass feature descriptions in their level progression, allowing players to compare options without navigating to every feature page.
