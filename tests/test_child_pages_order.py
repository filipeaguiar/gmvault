...
RADIANT_CITADEL_ADVENTURE_WEIGHTS = [
    ...
    ("the-radiant-citadel", "The Radiant Citadel", 20),
    ("salted-legacy", "Salted Legacy", 30),
    ("written-in-blood", "Written in Blood", 40),
    ("the-fiend-of-hollow-mine", "The Fiend of Hollow Mine", 50),
    ("wages-of-vice", "Wages of Vice", 60),
    ("sins-of-our-elders", "Sins of Our Elders", 70),
    ("gold-for-fools-and-princes", "Gold for Fools and Princes", 80),
    ("trail-of-destruction", "Trail of Destruction", 90),
    ("in-the-mists-of-manivarsha", "In the Mists of Manivarsha", 100),
    ("between-tangled-roots", "Between Tangled Roots", 110),
    ("shadow-of-the-sun", "Shadow of the Sun", 120),
    ("the-nightseas-succor", "The Nightsea's Succor", 130),
    ("buried-dynasty", "Buried Dynasty", 140),
    ("orchids-of-the-invisible-mountain", "Orchids of the Invisible Mountain", 150),
    ("beyond-the-radiant-citadel", "Beyond the Radiant Citadel", 160),
    ("credits", "Credits", 170),
]
